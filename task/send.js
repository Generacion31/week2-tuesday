...
function selectPizza(op) {
    // si op es Pequeña entonces debera retorna la pizza es Pequeña y cuesta $10
}

selectPizza("Pequeña");
selectPizza("Mediana");
selectPizza("Grande");
selectPizza("Familiar");
...
// 3. Crea una función que reciba como parámetro un string con un nombre del mes y debe retornar un string que indique la estación del año correspondiente. Si el mes no es válido, debe retornar "Mes no válido".

// escribe tu respuesta

// 4. Crea una función que retorne verdadero si el número recibido por parámetro es par y falso si es impar.
/*
tips - pares son los números que son divisibles entre 2 y su resto es igual a 0.
